...
顺序调度算法
 */
public class fx_extended1 {
    public static int vmNum=5;//虚拟机总数
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //设置虚拟机参数
            int vmid = 0;
            int[] mipss = new int[]{1000,1500,2000,2500,3000};//,3500,4000,4500,5000,1000
            long size = 10000;
            int ram = 512;
            long bw = 1000;
            int pesNumber = 1;
    ...
    private static Datacenter createDatacenter(String name){
        ...
        for(int i=0;i<vmNum;i++){
            ...
            hostList.add(new Host(hostId,
                    ...
                    storage,
                    peList,
                    new VmSchedulerTimeShared(peList)//时间共享虚拟机处理器调度策略
            ));
            hostId++;
        }
        //数据中心特征参数
